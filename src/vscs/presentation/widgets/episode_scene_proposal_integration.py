...
from vscs.application.story_analysis import StoryAnalysisCacheState, StorySourceReader
...
def install_episode_scene_proposal_action(services: ApplicationServices) -> None:
    ...
    def install_story_panel(self: BrowseableStoryWorkspaceWidget) -> None:
    ...
    def set_story_actions(self: BrowseableStoryWorkspaceWidget, story) -> None:
    ...
    def generate_planning_proposals(self: BrowseableStoryWorkspaceWidget) -> None:
        ...
        except (StoryAnalysisCacheError, RuntimeError) as exc:
            self._error(str(exc))
            return
