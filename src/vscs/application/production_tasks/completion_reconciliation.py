"""Reconcile governed Generated Media selection back to ProductionTask completion."""
...
class ProductionTaskCompletionReconciliationService:
    ...
    def _requirements(
        ...
        return tuple(requirements), tuple(sorted(findings, key=lambda item: (item.code, item.message)))
