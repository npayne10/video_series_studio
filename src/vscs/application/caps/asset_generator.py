        ...
        *,
        ...
        for offset, result in enumerate(generated):
            ...
            provenance = {
                ...
                "knowledge_profile": package.knowledge_id,
                ...
                reference = self.references.create(
                    ...
                    CanonicalReferenceCreate(
                        ...
                        notes=(
                            ...
                            f"Knowledge profile: {package.knowledge_id}\n"
        ...
        self._logger.info(
            "Generated %s CAIE/XCIC Core candidates for %s (%s; knowledge=%s)",
            len(created_ids),
            asset_id,
            asset.category.value,
            package.knowledge_id,
        )
