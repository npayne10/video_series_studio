    ...
    def infer_requirements(
        ...
        *,
        ...
        instructions = (
            ...
            "Shot/Scene authority. For characters, Shot-local authority is mandatory: infer a "
            "character only when the individual Shot title, narrative purpose, required action, "
            "dialogue requirement, or continuity requires that character. Do not promote a "
            "character merely because that character appears elsewhere in the Scene. The only "
            "exception is an explicit Scene persistence constraint such as 'persistent character:' "
            "or 'always present character:'. Do not propose Camera, Lighting, or Reference assets; those are "
