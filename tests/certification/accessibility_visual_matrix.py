...
_CERTIFICATION_TEST = (
    "tests/certification/"
    "test_onboarding_accessibility_visual_certification.py"
)
...
ACCESSIBILITY_VISUAL_MATRIX = (
    AccessibilityVisualEvidence(
        ...
        (
            f"{_CERTIFICATION_TEST}::"
            "test_onboarding_surfaces_have_accessible_names",
        ),
    ),
    AccessibilityVisualEvidence(
        ...
        (
            f"{_CERTIFICATION_TEST}::"
            "test_primary_controls_have_names_and_tooltips",
        ),
    ),
    AccessibilityVisualEvidence(
        "Stable object names",
        (
            f"{_CERTIFICATION_TEST}::"
            "test_certified_object_names_are_unique_and_stable",
        ),
    ),
    AccessibilityVisualEvidence(
        ...
        (
            f"{_CERTIFICATION_TEST}::"
            "test_onboarding_action_language_is_consistent",
        ),
    ),
    AccessibilityVisualEvidence(
        ...
        (
            f"{_CERTIFICATION_TEST}::"
            "test_visible_overlays_assign_focus_to_an_action",
    ...
    AccessibilityVisualEvidence(
        ...
        (
            f"{_CERTIFICATION_TEST}::"
            "test_onboarding_renders_with_light_and_dark_palettes",
        ),
    ),
    AccessibilityVisualEvidence(
        ...
        (
            f"{_CERTIFICATION_TEST}::"
            "test_beginner_and_expert_modes_preserve_core_workspace",
    ...
    AccessibilityVisualEvidence(
        ...
        (
            f"{_CERTIFICATION_TEST}::"
            "test_validation_status_is_textual_not_colour_only",
